...
def experiment(game):
    ...
    for lr in lrs:
        for i in epsilon_config:
            ...
            np.save('test_wr_connect4_' + str(game) + '_' + str(lr) + '_' + str(i) + '_rp', test_wr_rp)
            np.save('test_wr_list_connect4_' + str(game) + '_' + str(lr) + '_' + str(i) + '_op', test_wr_list_op)
            np.save('test_wr_list_connect4_' + str(game) + '_' + str(lr) + '_' + str(i) + '_rp', test_wr_list_rp)
            np.save('training_time_' + str(game) + '_' + str(lr) + '_' + str(i) + '_op', training_time)
            print('\n')
