...
def experiment(game):
    ...
    for lr in lrs:
        for i in epsilon_config:
            ...
            np.save('Qlearning_results/train_wr_tictactoe_' + str(game) + '_' + str(lr) + '_' + str(i), q_agent.total_wins)
            np.save('Qlearning_results/train_ep_tictactoe_' + str(game) + '_' + str(lr) + '_' + str(i), q_agent.total_eps)
            np.save('Qlearning_results/test_wr_tictactoe_' + str(game) + '_' + str(lr) + '_' + str(i), test_wr)
            np.save('Qlearning_results/test_wr_list_tictactoe_' + str(game) + '_' + str(lr) + '_' + str(i), test_wr_list)
            np.save('Qlearning_results/training_time_' + str(game) + '_' + str(lr) + '_' + str(i), training_time)
            print('\n')
